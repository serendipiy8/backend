    ...
    <div class="open">
        <div class="sales-board">
            <div class="sales-board-intro">
                <h2>开心麻花✖百老汇2024贺岁大戏《婚礼歌手》</h2>
                <p>婚礼歌手罗比见证了无数情侣的幸福时刻却在自己的婚礼上被当众抛弃，不再相信爱情的他开始揽乱每一场参与的婚礼。为了让罗比走出阴影，女服务生莱莉如邀请他来为自己两周后的婚礼做准备
                    随着婚期临近，罗比发现自己爱上了这个单纯美丽的女孩。逃婚的未婚妻突然出现，完美情敌背地里是劈腿渣男....坠入爱河，谁能上岸?
                </p>
            </div>
